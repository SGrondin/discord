    ...
    {|
{
  ...
  [%expect {|
    ((id 616658324351352842) (name "Tulsa Guys")
     ...
     (presences
      ((((user ((id 209048672195969025))) (guild_id ()) (status Online)
         (activities ())
         (client_status ((desktop ()) (mobile ()) (web (Online)))))
        ((user ((id 221972732596846592))) (guild_id ()) (status Online)
         (activities ())
         (client_status ((desktop (Online)) (mobile ()) (web ()))))
        ((user ((id 364954358473031680))) (guild_id ()) (status Idle)
         (activities ()) (client_status ((desktop (Idle)) (mobile ()) (web ()))))
        ((user ((id 616721445933809727))) (guild_id ()) (status Online)
         (activities ())
         (client_status ((desktop (Online)) (mobile ()) (web ()))))
        ((user ((id 791358895678423040))) (guild_id ()) (status Online)
         (activities
